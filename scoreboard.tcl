...
#  Jul 24, 2020 02:04:34 AM CEST  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top45 {base} {
    ...
    wm geometry $top 670x522+404+417
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    ttk::combobox $top.tCo69 \
        -values cbPlayerAway -font TkTextFont -textvariable cbPlayerAway \
        -foreground {} -background {} -takefocus {} 
    vTcl:DefineAlias "$top.tCo69" "TCombobox5" vTcl:WidgetProc "Toplevel1" 1
    bind $top.tCo69 <<SetBalloon>> {
        set ::vTcl::balloon::%W {JO}
    }
